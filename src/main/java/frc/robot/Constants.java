...
public class Constants {
    ...
    public static final int FL_DRIVE_MOTOR_CAN_ID = 10;
    public static final int FL_TURN_MOTOR_CAN_ID = 11;
    public static final int FR_DRIVE_MOTOR_ID = 40;
    public static final int FR_TURN_MOTOR_ID = 41;
    public static final int BL_DRIVE_MOTOR_ID = 20;
    public static final int BL_TURN_MOTOR_ID = 21;
    public static final int BR_DRIVE_MOTOR_ID = 30;
    public static final int BR_TURN_MOTOR_ID = 31;
                    //CANCODERS\\
    public static final int CANCODER_FL = 12;
    public static final int CANCODER_FR = 42;
    public static final int CANCODER_BL = 22;
    ...
    public static final int INTAKE_SECOND_MOTOR_CAN_ID = 50;
